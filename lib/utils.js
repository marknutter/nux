...
Collection.prototype.children = function children() {
  ...
  return this.__queryNode ? this.__queryNode.setIn(selector(this.__query).concat('children'), children) : children;
}
...
Collection.prototype.props = function props() {
  ...
  return this.__queryNode ? this.__queryNode.setIn(selector(this.__query).concat('props'), props) : props;
}
...
Collection.prototype.style = function style() {
  ...
  return this.__queryNode ? this.__queryNode.setIn(selector(this.__query).concat(['props', 'style']), style) : style;
}
...
Collection.prototype.events = function events() {
  ...
  return this.__queryNode ? this.__queryNode.setIn(selector(this.__query).concat(['props', 'events']), events) : events;
}
