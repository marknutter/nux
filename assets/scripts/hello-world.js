...
var helloWorld = init(function (state, action) {
  switch (action.type) {
...
module.exports = exports['default'];
},{"./mapValues":29}],26:[function(require,module,exports){
(function (process){
'use strict';
...
},{"../createStore":22,"./isPlainObject":28,"./mapValues":29,"./pick":30,"_process":3}],27:[function(require,module,exports){
/**
