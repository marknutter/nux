...
var _todoReducers = require("./todo-reducers");

var submitTodo = _todoReducers.submitTodo;
var toggleTodo = _todoReducers.toggleTodo;

var init = require("./../../lib/index").init;

var todoUi = require("./todo-ui").todoUi;
...
},{"./../../lib/index":5,"./todo-reducers":3,"./todo-ui":4}],2:[function(require,module,exports){
"use strict";
...
},{"immutable":25}],3:[function(require,module,exports){
"use strict";

exports.submitTodo = submitTodo;
exports.toggleTodo = toggleTodo;
Object.defineProperty(exports, "__esModule", {
  value: true
});

var todoComponent = require("./todo-component").todoComponent;

var selector = require("./../../lib/utils").selector;

var todosPathArray = ["div#app div#todos div#todo-container children"];

function submitTodo(state) {
  var todos = state.getIn(selector("div#app div#todos div#todo-container children"));
  var tag = "div#" + todos.size;
  var title = state.getIn(selector("div#app div#todos form#new-todo-form input props value"));

  var newTodo = todoComponent(title, tag);
  ...
  return state.setIn(selector("div#app div#todos form#new-todo-form input props value"), "").setIn(selector("div#app div#todos div#todo-container children"), sortedTodos);
}

function toggleTodo(state, tag) {
  var checked = state.getIn(selector("div#app div#todos div#todo-container " + tag + " input props checked"));
  if (checked === undefined) {
    var newState = state.setIn(selector("div#app div#todos div#todo-container " + tag + " input props checked"), "checked");
    ...
    var newState = state.deleteIn(selector("div#app div#todos div#todo-container " + tag + " input props checked"));
    return newState.deleteIn(selector("div#app div#todos div#todo-container " + tag + " span.title props style textDecoration"));
  }
}

},{"./../../lib/utils":8,"./todo-component":2}],4:[function(require,module,exports){
"use strict";
  ...
  if (store.getState().get("routes")) {
    ...
    store.getState().get("routes").forEach(function (action, route) {
      router.add(route, function (r) {
        store.dispatch(Object.assign(action.toJS(), r));
      });
    });
...
function reducer(appReducer) {
  ...
  var initialState = fromJS(Object.assign({ ui: initialUI }, { routes: options.routes }), function (key, value) {
